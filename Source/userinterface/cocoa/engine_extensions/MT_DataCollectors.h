...
{
    ar & MT_BOOST_MEMBER_SERIALIZATION_NVP("inst", get<0>(data));
    ar & MT_BOOST_MEMBER_SERIALIZATION_NVP("cycles", get<1>(data));
    ar & MT_BOOST_MEMBER_SERIALIZATION_NVP("data", get<2>(data));
}
